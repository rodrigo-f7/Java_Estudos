...
Pode colocar a condição do escaleno no lugar da do isósceles e a do isósceles como sendo o senão para economizar espaço no programa.
Pois se os 3 não são iguais e nem diferentes, resta que 1 é diferente dos outros dois.
 */